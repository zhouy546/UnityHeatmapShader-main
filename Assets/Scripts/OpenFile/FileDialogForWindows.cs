...
public static class FileDialogForWindows
{
    ...
    public static string FileDialog(string title, int selectIndex ,params string[] extensions)
    {
        ...
        filters.Add("视频"); filters.Add("*.mp4;*.mov;*.avi;");
        filters.Add("图片"); filters.Add("*.jpg;*.png;*.gif;*.jpeg;*.bmp");
        //foreach (var ext in extensions)
        //{
        //    filters.Add(ext); filters.Add("*" + ext);
        //}
        ofn.filter = Filter(filters.ToArray());
        ofn.filterIndex = selectIndex;
